...
// ── Signal — identical to Algo3 (EMA Ribbon Swing v2) ────────────
//
// Entry identical to Algo3: same 5 hard gates + 6/7 scored conditions.
// What differs is ONLY the exit logic (fixed SL/TP, opposite signal, $1000 stop).
//
...
// ── Fixed SL/TP exit — no trailing, no phases ────────────────────
//
// Exits:
//   1. Static SL hit  (set at entry ± 1.5×ATR, never moves)
//   2. Static TP hit  (set at entry ± 3×ATR)
//   3. $1000 adverse  (price moves $1000 against entry — hard dollar stop)
//
// Opposite-signal exit is handled in server.js (needs generateSignal call on each candle).
//
